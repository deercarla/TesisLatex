...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Tesis/imagenes/inscriptos-por-carrera.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Tesis/imagenes/modulos-curso.PNG}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Tesis/imagenes/ast.PNG}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Tesis/imagenes/diagrama-base.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Tesis/imagenes/varianza-explicada.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Tesis/imagenes/codigo-similar.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{Tesis/imagenes/heatmap-1-crear album.png}
        \caption{Heatmap del ejercicio \emph{crear\_album}}
        \label{fig:figura1}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{Tesis/imagenes/heatmap-1-tirar.png}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{Tesis/imagenes/heatmap-1-propagar.png}
        \caption{Heatmap del ejercicio \emph{propagar}}
        \label{fig:figura1}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{Tesis/imagenes/heatmap-1-prob generala.png}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{Tesis/imagenes/heatmap-2-crear album.png}
        \caption{Heatmap del ejercicio \emph{crear\_album}}
        \label{fig:figura1}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{Tesis/imagenes/heatmap-2-tirar.png}
        \caption{Heatmap del ejercicio \emph{tirar}}
        \label{fig:figura2}
    \end{subfigure}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{Tesis/imagenes/ari.png}
        \caption{ARI}
        \label{fig:figura1}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{Tesis/imagenes/nmi.png}
        \caption{NMI}
        \label{fig:figura2}
    \end{subfigure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Tesis/imagenes/clusterxcluster.png}
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=0.5\textwidth]{Tesis/imagenes/cluster.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Tesis/imagenes/entregas - finalizados.png}
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Tesis/imagenes/entregas - clique13.png}
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Tesis/imagenes/entregas - no-clique13.png}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{Tesis/imagenes/unique-1.png}
        \caption{Cantidad total de código repetido y de código único por ejercicio}
        \label{fig:figura1}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{Tesis/imagenes/unique-2.png}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{Tesis/imagenes/codigo-reptido-original.png}
        \caption{Datos originales.}
        \label{fig:figura3}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{Tesis/imagenes/codigo-reptido-uniques.png}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{Tesis/imagenes/porcentaje - original.png}
        \caption{Datos originales.}
        \label{fig:figura5}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{Tesis/imagenes/porcentaje - unniques.png}
        \caption{Datos sin código repetido.}
        \label{fig:figura6}
    \end{subfigure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Tesis/imagenes/cluster-normalized.png}
...
\begin{figure}[H]
    ...
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{Tesis/imagenes/porcentaje - fuzzy.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Tesis/imagenes/fill functiontodos_los_graficos_en_una_sola_figura.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Tesis/imagenes/zerostodos_los_graficos_en_una_sola_figura.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Tesis/imagenes/proporcion - entregas (1).png}
